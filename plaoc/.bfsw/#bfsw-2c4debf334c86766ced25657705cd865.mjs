...
// bfsp-wrapper:./gateway/#bfsp#
var bfsp_default9 = defineConfig((info) => {
  const config = {
    name: "@bfsx/gateway",
    exports: {
      ".": "./index.ts"
...
// bfsp-wrapper:/Users/mac/Desktop/waterbang/project/android-deno-runtime-example/plaoc/gateway/#bfsp.ts
var newDefault5 = Object.assign(bfsp_default9 ?? {}, { relativePath: "./gateway" });
var bfsp_default10 = newDefault5;

// #bfsw.ts
var bfsw_default = defineWorkspace(() => {
  const config = {
    projects: [bfsp_default2, bfsp_default4, bfsp_default8, bfsp_default10, bfsp_default6]
  };
  return config;
});
export {
