...
var _routes, _onPushEvt, _onPopEvt, _onReplaceEvt, _ownNavs, _onForkEvt, _onActivatedEvt, _onDestroyEvt;
...
const _BfcsNavigator = class {
  constructor(info, parentInfo, _ffi) {
    ...
    __privateAdd(this, _onActivatedEvt, new EvtOut());
  ...
  fork(opts) {
    ...
    if (result >= 0) {
      const newNavigator = new _BfcsNavigator(Object.freeze({ data: opts.data, nid: result }), this.info, this._ffi);
  ...
  get onActivated() {
    return __privateGet(this, _onActivatedEvt).toAsyncGenerator();
  }
