...
import org.bfchain.rust.example.webView.topbar.DWebTopBar
import org.bfchain.rust.example.webView.topbar.TopBarFFI
                            ...
                            if (request !== null) {
                                ...
                                if (jumpWhitelist(url)) {
                                    try {
                                        ...
                                        // 映射本地文件的资源文件 https://channelId.bmr9vohvtvbvwrs3p4bwgzsmolhtphsvvj.dweb/open/index.mjs -> /plaoc/index.mjs
